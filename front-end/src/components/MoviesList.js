        ...
        {movies.map((movie, index) => (
          ...
          >
            ...
            <div className="flex justify-between">
              <button onClick={(e) => { e.stopPropagation(); addMovieToWatched(movie._id); }} className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md">
                Vu
              </button>
              <button onClick={(e) => { e.stopPropagation(); addMovieToList(movie._id); }} className="bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-md">
                À Voir
              </button>
              <button onClick={(e) => { e.stopPropagation(); addMovieToFavorites(movie._id); }} className="bg-yellow-500 hover:bg-yellow-600 text-white py-2 px rounded-md">
                Favoris
              </button>
            </div>
          </div>
